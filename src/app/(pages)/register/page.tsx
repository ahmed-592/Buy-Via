          ...
          <form onSubmit={handleSubmit(signUpUser)} >
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input aria-invalid={Boolean(errors.password)} className="text-black" {...register("password")} id="password" type="password" placeholder="Ali@123" required />
                {errors.password && (
              ...
              <div className="grid gap-2">
                ...
                <Input aria-invalid={Boolean(errors.rePassword)} className="text-black" {...register("rePassword")} id="repassword" type="password" placeholder="Ali@123" required />
                {errors.rePassword && (
